...
x_bc = read.csv("~/Multi_seq/NL9_1_1009_combo.csv",header=F)#Path to matrix combination
...
doublet_rate=(length(bc_match_multi))*100/nb_cells
...
write.table(final,file="P9.1.1406_bc_per_group.txt",quote=FALSE,sep="\t",col.names=T,row.names=F)
