...
leiden_plots(embedding, knn, ic_edges, out_dir)
del ic_edges ; gc.collect()
...
np.savez_compressed(os.path.join(out_dir, 'init.npz'), embedding=embedding, membership=knn.membership, init=init)
