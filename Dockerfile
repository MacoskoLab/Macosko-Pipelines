...
# gcloud builds submit --timeout=3h --region=us-central1 -t us.gcr.io/mccarroll-scrna-seq/macosko-pipelines:$(git describe --match='' --always --abbrev=7 --dirty)_$(date +%s) .
